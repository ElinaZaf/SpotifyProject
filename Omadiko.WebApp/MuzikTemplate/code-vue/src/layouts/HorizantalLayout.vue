<template>
  <div>
    ...
    <div class="wrapper">
      <!-- TOP Nav Bar -->
      <DefaultNavBar title="Dashboard" v-if="$route.name === 'dashboard.home-2'" :homeURL="{ name: 'dashboard.home-1' }" :sidebarGroupTitle="sidebarGroupTitle" @toggle="sidebarMini" :logo="logo" :horizontal="horizontal" :items="items">
      ...
      <MenuNavBar title="Dashboard" v-if="$route.name === 'dashboard.home-3'" :homeURL="{ name: 'dashboard.home-1' }" :sidebarGroupTitle="sidebarGroupTitle" @toggle="sidebarMini" :logo="logo" :horizontal="horizontal" :items="items">
        <template slot="responsiveRight">
          <ul class="navbar-nav ml-auto navbar-list">
            <li class="nav-item">
              <a class="search-toggle iq-waves-effect language-title" href="#"><img :src="selectedLang.image" alt="img-flaf" class="img-fluid mr-1" style="height: 16px; width: 16px;" /> <i class="ri-arrow-down-s-line"></i></a>
