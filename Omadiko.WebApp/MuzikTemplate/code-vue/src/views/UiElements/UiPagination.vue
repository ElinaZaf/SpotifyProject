...
export default {
  ...
  mounted () {
    core.index()
    let pageination = document.getElementsByClassName('iq-page-primary')[0]
    ...
    let pageinationSuccess = document.getElementsByClassName('iq-page-success')[0]
    ...
    let pageinationInfo = document.getElementsByClassName('iq-page-info')[0]
