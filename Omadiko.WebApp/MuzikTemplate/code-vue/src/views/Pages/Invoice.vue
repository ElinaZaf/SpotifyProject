          ...
          <template v-slot:body>
            ...
            <b-row>
              <b-col lg="12">
                ...
                <h5 class="mt-5">{{ invoice.detail }}</h5>
                <div class="table-responsive-sm">
        ...
        order: [
          {
            ...
            orderStatus: 2,
            orderID: '250028',
            billingAddress: 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia <br> Phone: +123 456 7890 <br> Email: demo@Muzik.com <br> Web: www.Muzik.com',
            shippingAddress: 'PO Box 16122 Collins Street West <br> Victoria 8007 Australia <br> Phone: +123 456 7890 <br> Email: demo@Muzik.com <br> Web: www.Muzik.com'
          }
        ],
        orderSummaryFields: [
          {
