               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class="active">
                     ...
                     <ul id="admin" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                        ...
                        <li class="active"><a href="admin-writer.html"><i class="las la-user"></i>Writer</a></li>
                  ...
                  <div class="iq-card">
                     <div class="iq-card-header d-flex justify-content-between">
                        <div class="iq-header-title">
                           <h4 class="card-title">Writer Lists</h4>
                        </div>
                        <div class="iq-card-header-toolbar d-flex align-items-center">
                           <a href="admin-add-writer.html" class="btn btn-primary">Add New Writer</a>
                        </div>
                     </div>
                           ...
                           <table class="data-tables table table-striped table-bordered" style="width:100%">
                              <thead>
                                 <tr>
                                    ...
                                    <th style="width: 35%;">Writer Description</th>
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td>9 jan, 1968</td>
                                    <td>
                                       <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rhoncus non elit a scelerisque.</p>
                                    </td>
                                    <td>
